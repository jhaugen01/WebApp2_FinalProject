<?php 
  ...
  // Check connection
	...
	$sql = "INSERT INTO orders (username, size, crust, topping_1, topping_2, topping_3, cost, status) VALUES ('$user', '$size_name', '$crust_name', '$topping1_name', '$topping2_name', '$topping3_name', '$cost', 'None')";
	$conn->query($sql);
